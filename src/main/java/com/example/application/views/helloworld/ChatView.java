...
public class ChatView extends VerticalLayout {
    ...
    public ChatView() {
        ...
        add(chat, input, resetButton);

        // Full-size center and add padding
        this.setHorizontalComponentAlignment(Alignment.CENTER, chat, input, resetButton);
        ...
        resetButton.setWidth("100px"); // Set a fixed width for the reset button
        chat.setMaxWidth("800px"); // Until to a certain size
        input.setMaxWidth("800px"); // Until to a certain size
    ...
    private void onReset() {
        openAI.clearAll(); // Remove all messages from the chat
        chat.setItems();
    }
